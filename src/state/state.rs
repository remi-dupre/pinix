...
pub struct State {
    ...
    state_builds: HashMap<BuildStepId, StateBuild>,
    state_download: HashMap<BuildStepId, StateDownload>,
    file_transfers: HashMap<BuildStepId, BuildStepId>,
    msg_buffer: HashMap<BuildStepId, Vec<String>>,
}
